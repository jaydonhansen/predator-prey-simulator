...
#define INITIAL_PREY                    4000    // Prey n(0)
...
#define PREDATOR_HUNGER_LIMIT           10     // How hungry a predator can get before dying
#define NUM_TICKS                       500    // Number of times to iterate
